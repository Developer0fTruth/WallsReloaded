...
import com.thundergemios10.walls.util.MessageUtil;
...
public class HookManager {
	...
	public boolean checkConditions(String str,String... args){
		...
		for(String split:MessageUtil.replaceVars(str, args).split(";")){
			...
			if(!flag){
				System.out.println("[Walls][HookManager]Condition does not contian a compare operator: "+split);
				return false;
			}
			try{
				...
				System.out.println("[Walls][HookManager]Error parsing value for: "+split);
				return false;
			}
		}
		return true;
