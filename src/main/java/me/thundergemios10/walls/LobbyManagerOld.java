            ...
            try {
                ...
                for (Player p: active) {
                    if (signno < signs[b].length) {
                        ...
                        signs[b][signno].setLine(line, (Walls.auth.contains(p.getName()) ? ChatColor.DARK_BLUE : ChatColor.BLACK) + ((p.getName().equalsIgnoreCase("Double0negative")) ? "Double0" : p.getName()));
                ...
                for (Player p: inactive) {
                    if (signno < signs[b].length) {
                        signs[b][signno].setLine(line, (Walls.auth.contains(p.getName()) ? ChatColor.DARK_RED : ChatColor.GRAY) + ((p.getName().equalsIgnoreCase("Double0negative")) ? "Double0" : p.getName()));
                        signs[b][signno].update();
                        line++;
                        if (line == 4) {
                            line = 0;
